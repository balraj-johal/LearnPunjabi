...
function RiversMid(props) {
    ...
    let calculate = () => {
        if (top.current.clientHeight <= 0) return setTimeout(() => { 
            calculate() 
        }, 100);
    ...
    return(
        <>
            ...
            >
                <path 
                    d="M113.143 -4.42109e-06C113.143 555.718 
                        113.571 556.718 113.571 1097M12 0C12 555.718 
                        12.4286 556.718 12.4286 1097M214.286 
                        -8.84219e-06C214.286 555.718 214.714 
                        556.718 214.714 1097M315.429 -1.32633e-05C315.429
                        555.718 315.857 556.718 315.857 1097M416.571
